...
public class Donate extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        executorService = Executors.newSingleThreadExecutor(); // Single-thread executor
        mainHandler = new Handler(Looper.getMainLooper());     // Main thread handler
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mSubmitBtn.setOnClickListener(v -> {
            ...
            // Move Firestore operation to a background thread
                ...
                collectionReference.add(user)
                        .addOnSuccessListener(documentReference -> {
                            ...
                            mainHandler.post(() -> {
                                ...
                                Log.d("ThreadCount", "Active threads: " + threadSet.size());
                                for (Thread thread : threadSet) {
                                    Log.d("ThreadDetails", "Name: " + thread.getName() + ", State: " + thread.getState());
                                }
                        ...
                        .addOnFailureListener(e -> {
                            // Post failure back to main thread
                            mainHandler.post(() -> {
